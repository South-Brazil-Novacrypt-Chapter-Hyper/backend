...
export class changeProjectsScopeToString1604239555318 implements MigrationInterface {
    name = 'changeProjectsScopeToString1604239555318'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "projects" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "platform" varchar NOT NULL, "description" varchar NOT NULL, "scope" boolean NOT NULL)`);
